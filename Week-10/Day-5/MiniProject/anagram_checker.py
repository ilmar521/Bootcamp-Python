...
class AnagramChecker:
    ...
    def get_anagrams(self, word):
        all_annagrams = set(["".join(perm) for perm in itertools.permutations(word)])
        list_of_annagrams = [word for word in all_annagrams if word.upper() in self.list_of_words]
