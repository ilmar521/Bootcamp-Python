...
class FormCV(flask_wtf.FlaskForm):
    ...
    About = wtforms.StringField("About", validators=[wtforms.validators.DataRequired()])
    ...
    responsibilities = wtforms.StringField("Responsibilities", validators=[wtforms.validators.DataRequired()])
